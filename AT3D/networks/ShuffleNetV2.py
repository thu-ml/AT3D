# ref: https://github.com/ShawnXYang/Face-Robustness-Benchmark/blob/master/RobFR/networks/ShuffleNetV2.py
...
from AT3D.networks.FaceModel import FaceModel
...
class ShufflenetV2(nn.Module):
    def __init__(
        self, n_class=1000, input_size=224, width_mult=1.0, stride=2, pooling="Linear"
    ):
...
class ShuffleNetV2(FaceModel):
    def __init__(self, stride=2, pooling="Linear", width_mult=1.0, **kwargs):
        ...
        channel = "bgr"
        FaceModel.__init__(self, url=url, net=net, channel=channel, **kwargs)
