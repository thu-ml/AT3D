# ref: https://github.com/ShawnXYang/Face-Robustness-Benchmark/blob/master/RobFR/networks/ShuffleNet.py
...
class ShuffleUnit(nn.Module):
    def __init__(
        self, in_channels, out_channels, groups=1, grouped_conv=True, combine="add"
    ):
...
class ShuffleNet(nn.Module):
    ...
    def __init__(self, groups=3, in_channels=3, num_classes=1000, pooling="Linear"):
        ...
        self.conv1 = conv3x3(
            self.in_channels, self.stage_out_channels[1], stride=1  # stage 1
        )
